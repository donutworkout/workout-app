...
struct StreakView: View {
    @EnvironmentObject var router: Router  // ✅ Ganti dari @Environment(\.dismiss)
    ...
    var body: some View {
        ScrollView(showsIndicators: false) {
            VStack(spacing: 32) {
                ...
                ZStack {
                    ...
                    // Layer 2: Character di tengah line 1
                    GeometryReader { geometry in
        ...
        .navigationTitle("Streak")  // ✅ Tambahkan
        .navigationBarTitleDisplayMode(.inline)  // ✅ Tambahkan
        .toolbar {  // ✅ Tambahkan toolbar
            ToolbarItem(placement: .topBarLeading) {
                Button("Back", systemImage: "chevron.left") {
                    router.selectedTab = 0  // Set ke menu tab
                    router.navigateTo(.menu)  // Navigate ke menu
                }
            }
        }
        .onAppear {
